...
export default class SimpleDrawer extends React.Component {
    ...
    render() {
        const _a = this.props, { className, overlayClassName, overlayStyle, navClassName, navStyle, open, navRender, onOverlayTap, closeOffset, openSpeedSec } = _a, other = __rest(_a, ["className", "overlayClassName", "overlayStyle", "navClassName", "navStyle", "open", "navRender", "onOverlayTap", "closeOffset", "openSpeedSec"]);
