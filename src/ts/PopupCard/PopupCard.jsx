...
var PopupCard = (function (_super) {
    ...
    PopupCard.prototype._onTouchStart = function (e) {
    ...
    PopupCard.prototype.render = function () {
        ...
        return (<div className={masterClassName} onClick={this._onClick.bind(this)} onTouchStart={this._onTouchStart.bind(this)} style={masterStyle} {...otherProps}>
